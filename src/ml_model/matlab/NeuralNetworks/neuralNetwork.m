...
X = data(1:floor(0.9 * size(data, 1)), 1:feature_size);
y = data(1:floor(0.9 * size(data, 1)), size(data, 2));
% y(y==1) = 2;
% y(y==0) = 1;

X_test = data(floor(0.9 * size(data, 1)) : end, 1:feature_size);
...
% csvwrite('../../data/version_Theta1.csv', Theta1);
% csvwrite('../../data/version_Theta2.csv', Theta2);
